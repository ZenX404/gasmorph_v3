...
- `.env.local`：填写本地测试 RPC 与私钥（仅本机保存，不入库，可用 `scripts/set-env.ps1` 生成）
...
- 如需 ERC-4337 bundler/paymaster，本地可运行简化 paymaster 或接入开源本地实现
...
- 兜底注资：若 sponsor 余额 < 0.1 ETH，会自动由 faucet 账户（anvil #0，地址 `0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266`，私钥 `0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80`）转入 1 ETH
...
## 补贴账户备份（当前生效）
- Sponsor（补贴账户，anvil #1）：地址 `0xC27777d6cAc41Cca4e69e5266064A92F0f2c42a9`；私钥 `0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603c9a21c087`
