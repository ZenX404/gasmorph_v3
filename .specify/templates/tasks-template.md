...
**Tests**: The examples below include test tasks. 所有新功能必须包含单元测试与页面级 E2E，请将测试任务写入各用户故事阶段。
...
- [ ] T012 [P] [US1] Page-level E2E test for [user journey] in tests/e2e/[name].spec.ts
### Implementation for User Story 1
- [ ] T013 [P] [US1] Create [Entity1] model in src/models/[entity1].py
- [ ] T014 [P] [US1] Create [Entity2] model in src/models/[entity2].py
- [ ] T015 [US1] Implement [Service] in src/services/[service].py (depends on T012, T013)
...
- [ ] T021 [P] [US2] Page-level E2E test for [user journey] in tests/e2e/[name].spec.ts
...
- [ ] T028 [P] [US3] Page-level E2E test for [user journey] in tests/e2e/[name].spec.ts
...
- [ ] TXXX [P] Additional unit tests (必选) in tests/unit/
...
Task: "Page-level E2E test for [user journey] in tests/e2e/[name].spec.ts"
